...
/**
    ...
    public static String getResponseFromServer(final URL constructedUrl, final String encoding) {
        return getResponseFromServer(constructedUrl, null, encoding);
    }
     ...
     * @return the response.
     */
    public static String getResponseFromServer(final URL constructedUrl, HostnameVerifier hostnameVerifier, final String encoding) {
